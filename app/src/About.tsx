  ...
  return (
    <div className="App">
      ...
      >
        ...
        <p>
          PMD Collab is a participatory project created by fans of the Pokemon
          Mystery Dungeon games (like Pokemon Mystery Dungeon: Explorers of Sky
          or Pokemon Mystery Dungeon: Red Rescue Team). The project provides
          assets of pokemons from every generations in a standard format. Those
          assets can be split in 2 categories: Portraits and Sprites.
        </p>
        ...
        <p>
          The main repository where every data comes from is hosted on github at{" "}
        ...
        <p>
          if you have drawn sprites or portraits, you can submit them in the
          #submissions channel of our discord (you can join at{" "}
          <a href='"https://discord.gg/skytemple"'>
            https://discord.gg/skytemple
          </a>
