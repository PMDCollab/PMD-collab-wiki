...
export default function PokemonRanking(
    ...
    return <div className="nes-select is-inline" style={{display:'flex', alignItems:'center', width:'initial'}}>
    <p style={{fontSize:'0.7em'}}>Rank by</p>
    <select style={{borderWidth:'2px', height:'40px', fontSize:'0.7em'}} value={props.rankBy} id="default_select" onChange={e=>{
