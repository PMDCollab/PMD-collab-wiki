...
export default function PokemonThumbnail(props: {info: ITracker, infoKey: string}){
    const image = props.info.portrait_files['Normal'] !== undefined ? <img className='my-img' alt='' src={`${CDN_URL}/portrait/${props.infoKey}/Normal.png`}/> : <h1 style={{height:'80px', margin:'0px'}}>?</h1>;
