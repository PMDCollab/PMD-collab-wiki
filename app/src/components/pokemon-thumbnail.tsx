...
export default function PokemonThumbnail(props: {info: ITracker, infoKey: string}){
    const image = props.info.portrait_files[Emotion.NORMAL] !== undefined ? <img className='my-img' alt='' src={`${process.env.PUBLIC_URL}/collab/portrait/${props.infoKey}/${Emotion.NORMAL}.png`}/> : <h1 style={{height:'80px', margin:'0px'}}>?</h1>;
