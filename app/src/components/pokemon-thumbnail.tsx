...
export default function PokemonThumbnail(props: {info: ITracker, infoKey: string}){
    return <div className='my-container nes-container nes-pointer' style={{display:'flex', flexFlow:'column', justifyContent:'space-between', alignItems:'center', width: '100px', margin:'20px'}}>
