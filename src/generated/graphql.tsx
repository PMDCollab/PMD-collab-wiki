...
export const CarrouselDocument = gql`
    query Carrousel($ids: [Int!]!, $withPortraitBounty: Boolean!, $withSpriteBounty: Boolean!, $withModifiedDate: Boolean!, $withFullyFeaturedPortrait: Boolean!, $withFullyFeaturedSprite: Boolean!, $withCredits: Boolean!, $withForms: Boolean!) {
  monster(filter: $ids) {
    id
    name
    rawId
