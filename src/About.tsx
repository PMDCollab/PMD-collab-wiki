  ...
  return (
    <Box>
      ...
      >
        ...
        <Typography>
          Custom sprites are licensed under <Link href="http://creativecommons.org/licenses/by-nc/4.0/?ref=chooser-v1">Attribution-NonCommercial 4.0 International</Link>
        </Typography>
        <Typography>
