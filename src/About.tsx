  ...
  return (
    <Box>
      ...
      >
        ...
        <Typography>
          Credits Mode allows you to select multiple Pokémon and generate a single credits file with the corresponding credits for all of them. If you are selecting specific variants of a Pokémon, also enable the option to include different forms.
        </Typography>
